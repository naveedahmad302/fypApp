...
const ProfileScreen: React.FC<TProfileStackNavigationProps<'Profile'>> = ({
  ...
  return (
    <ScrollView
      className="flex-1 bg-[#F9FAFB] px-7"
    ...
    >
      {isLoading ? (
        ...
        <>
          <View className=" mt-2 rounded-xl p-6">
            <View className="items-center mb-2">
              ...
              >
                ...
                <Text className="text-white text-center font-radio-canada font-medium ml-2">
                  Edit Profile
                </Text>
              </TouchableOpacity>
            </View>
          ...
          >
            <View className="flex-row">
              <View className="flex-1 items-center">
                <Text className="text-3xl font-radio-canada font-bold text-blue-500">
                  3
                </Text>
                <Text className="text-gray-600 font-radio-canada mt-1">
                  Assessments
                </Text>
              </View>
          ...
          <Text className="text-lg font-radio-canada mt-4 font-bold mb-6 text-gray-900">
            Assessment Journey
          </Text>
          ...
          >
            <View className="flex-row items-center mb-4">
              ...
              <Text className="flex-1  font-radio-canada font-medium text-gray-900">
                Eye Tracking
              </Text>
              <Text className="text-green-600 font-radio-canada font-medium">
                Completed
              </Text>
            </View>
          ...
          >
            <Text className="text-red-500 text-center font-radio-canada font-medium">
              Sign Out
            </Text>
          </TouchableOpacity>
          <View className="py-3 justify-center ">
            <Text className="text-center font-radio-canada font-thin text-gray-400">
              AutismSpectrumDetection v1.0.0
            </Text>
          </View>
        </>
      )}
